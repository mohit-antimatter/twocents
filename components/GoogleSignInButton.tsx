export default function GoogleSignInButton() {
  return (
    <a
      ...
      className="flex min-h-12 w-full items-center justify-center gap-3 rounded-xl border border-hairline bg-ink px-5 font-medium text-bg transition-[filter] hover:brightness-95"
    >
